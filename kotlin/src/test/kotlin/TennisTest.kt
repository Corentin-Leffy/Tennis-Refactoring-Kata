        ...
        val allScores: Collection<Array<Any>>
            ...
            get() =
                Arrays.asList(arrayOf(0, 0, "Love-All"),
                        ...
                        arrayOf(4, 0, "score.Win for player1"),
                        arrayOf(0, 4, "score.Win for player2"),
                        arrayOf(2, 1, "Thirty-Fifteen"),
                        arrayOf(1, 2, "Fifteen-Thirty"),
                        arrayOf(3, 1, "Forty-Fifteen"),
                        arrayOf(1, 3, "Fifteen-Forty"),
                        arrayOf(4, 1, "score.Win for player1"),
                        arrayOf(1, 4, "score.Win for player2"),
                        arrayOf(3, 2, "Forty-Thirty"),
                        arrayOf(2, 3, "Thirty-Forty"),
                        arrayOf(4, 2, "score.Win for player1"),
                        arrayOf(2, 4, "score.Win for player2"),
                        arrayOf(4, 3, "score.Advantage player1"),
                        arrayOf(3, 4, "score.Advantage player2"),
                        arrayOf(5, 4, "score.Advantage player1"),
                        arrayOf(4, 5, "score.Advantage player2"),
                        arrayOf(15, 14, "score.Advantage player1"),
                        arrayOf(14, 15, "score.Advantage player2"),
                        arrayOf(6, 4, "score.Win for player1"),
                        arrayOf(4, 6, "score.Win for player2"),
                        arrayOf(16, 14, "score.Win for player1"),
                        arrayOf(14, 16, "score.Win for player2"))
    }
